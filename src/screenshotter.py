...
class XrpFuturesCanvasScreenshotter:
    ...
    def take_screenshot(self, output_path: Path, headless: bool = True) -> None:
        ...
        try:
            ...
            page.goto(config.AppConfig.BITGET_XRP_FUTURES_URL, wait_until="domcontentloaded")
            ...
            raise RuntimeError("Przekroczono czas oczekiwania na załadowanie strony lub elementu.") from error
        finally:
